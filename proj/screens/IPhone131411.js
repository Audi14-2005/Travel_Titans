...
const IPhone131411 = () => {
  return (
    <View style={styles.iphone13149}>
      ...
      <Image
        style={[styles.iphone13149Child, styles.iphone13149ChildLayout]}
        contentFit="cover"
      ...
      />
      <Image
        style={[styles.iphone13149Inner, styles.ellipseIconPosition]}
        contentFit="cover"
      ...
      />
      <Image
        style={[styles.iphone13149Child1, styles.iphone13149ChildLayout]}
        contentFit="cover"
        source={require("../assets/ellipse-24.png")}
      />
    </View>
